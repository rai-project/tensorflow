...
for model_path, complete_name, pretty_name in zip(model_paths, model_names, pretty_names):
    ...
    yml_data['description'] = yml_data['description'].replace(last_model_name, complete_name)
    yml_data['model']['graph_path'] = yml_data['model']['graph_path'].replace(last_model_name, complete_name)
