...
func main() {
	...
	modeldir := flag.String("dir", "data", "Directory containing the trained model files. The directory will be created and the model downloaded into it if necessary")
