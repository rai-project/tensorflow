...
var fileDescriptor_37a8afc464c5489d = []byte{
	...
	0xb1, 0x38, 0x1e, 0xca, 0xcb, 0x3d, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39, 0xc6, 0x07, 0x8f,
	...
	0x09, 0xa2, 0x3b, 0xae, 0x38, 0x80, 0x31, 0x4a, 0x31, 0x3d, 0xb3, 0x24, 0xa3, 0x34, 0x49, 0x2f,
	0x39, 0x3f, 0x57, 0xbf, 0x28, 0x31, 0x53, 0xb7, 0xa0, 0x28, 0x3f, 0x2b, 0x35, 0xb9, 0x44, 0x1f,
	0x61, 0xc2, 0x0f, 0x46, 0xc6, 0x24, 0x36, 0x70, 0xd8, 0x18, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff,
	0x41, 0xef, 0xe9, 0x02, 0x31, 0x01, 0x00, 0x00,
}
...
func (m *TensorSliceProto_Extent) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.HasLength != nil {
		nn1, err1 := m.HasLength.MarshalTo(dAtA[i:])
		if err1 != nil {
			return 0, err1
		}
		i += nn1
